...
export const allButtons: ToolbarButtonConfig[] = [
  // Text formatting
  {
    ...
    icon: (active) => (
      <TextLabel text="B" bold color={active ? "#fff" : "#000"} />
    ),
  },
  {
    key: "italic",
    ...
    icon: (active) => (
      <TextLabel text="I" italic color={active ? "#fff" : "#000"} />
    ),
  },
  {
    key: "underline",
    ...
    icon: (active) => (
      <TextLabel text="U" underline color={active ? "#fff" : "#000"} />
    ),
  },
  {
    key: "strike",
  ...
  // Lists
  {
    ...
    icon: (active) => (
      <TextLabel text={"\u2022"} color={active ? "#fff" : "#000"} />
    ),
  },
  {
    key: "orderedList",
