...
### Piece Management
- [ ] 🔨 @jarric — Let users manage piece state: draft vs. published, shared in riff vs. not ready to share
- [ ] 🔨 @jarric — Clear distinction between drafts (in progress), submitted pieces (shared to a riff), and personal pieces (not in a riff)
